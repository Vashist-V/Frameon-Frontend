                ...
                <div className="bg-[#13131a] border border-[#2a2a3a] rounded-2xl p-8">
                    ...
                    <div className="relative my-5">
                        ...
                        <div className="relative flex justify-center text-xs text-gray-500">
                            <span className="bg-[#13131a] px-3">or continue with</span>
                        </div>
                    </div>

                    <button
                        onClick={handleGoogleLogin}
                        className="w-full bg-[#1c1c28] border border-[#2a2a3a] hover:border-gray-500 text-white font-medium py-3 rounded-xl transition-colors flex items-center justify-center gap-3"
                    >
